...
@JsonKey(name: 'generate') MonolithDefinesGenerateDto get generate;@JsonKey(name: 'flavors') Map<String, Map<String, String>> get flavors;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MonolithDefinesDto&&(identical(other.generate, generate) || other.generate == generate)&&const DeepCollectionEquality().equals(other.flavors, flavors));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,generate,const DeepCollectionEquality().hash(flavors));

@override
String toString() {
  return 'MonolithDefinesDto(generate: $generate, flavors: $flavors)';
}
...
@useResult
$Res call({
@JsonKey(name: 'generate') MonolithDefinesGenerateDto generate,@JsonKey(name: 'flavors') Map<String, Map<String, String>> flavors
});
...
/// Create a copy of MonolithDefinesDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? generate = null,Object? flavors = null,}) {
  return _then(_self.copyWith(
generate: null == generate ? _self.generate : generate // ignore: cast_nullable_to_non_nullable
...
class _MonolithDefinesDto implements MonolithDefinesDto {
  const _MonolithDefinesDto({@JsonKey(name: 'generate') required this.generate, @JsonKey(name: 'flavors') required final  Map<String, Map<String, String>> flavors}): _flavors = flavors;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MonolithDefinesDto&&(identical(other.generate, generate) || other.generate == generate)&&const DeepCollectionEquality().equals(other._flavors, _flavors));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,generate,const DeepCollectionEquality().hash(_flavors));
...
/// Create a copy of MonolithDefinesDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? generate = null,Object? flavors = null,}) {
