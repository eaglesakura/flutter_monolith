...
/// Adds pattern-matching-related methods to [MonolithInstallDto].
extension MonolithInstallDtoPatterns on MonolithInstallDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MonolithInstallDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MonolithInstallDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MonolithInstallDto value)  $default,){
final _that = this;
switch (_that) {
case _MonolithInstallDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MonolithInstallDto value)?  $default,){
final _that = this;
switch (_that) {
case _MonolithInstallDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'path')  String? path, @JsonKey(name: 'base64_file')  String? base64File, @JsonKey(name: 'text_file')  String? textFile, @JsonKey(name: 'properties')  Map<String, String>? properties)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonolithInstallDto() when $default != null:
return $default(_that.path,_that.base64File,_that.textFile,_that.properties);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'path')  String? path, @JsonKey(name: 'base64_file')  String? base64File, @JsonKey(name: 'text_file')  String? textFile, @JsonKey(name: 'properties')  Map<String, String>? properties)  $default,) {final _that = this;
switch (_that) {
case _MonolithInstallDto():
return $default(_that.path,_that.base64File,_that.textFile,_that.properties);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'path')  String? path, @JsonKey(name: 'base64_file')  String? base64File, @JsonKey(name: 'text_file')  String? textFile, @JsonKey(name: 'properties')  Map<String, String>? properties)?  $default,) {final _that = this;
switch (_that) {
case _MonolithInstallDto() when $default != null:
return $default(_that.path,_that.base64File,_that.textFile,_that.properties);case _:
  return null;
