...
/// Adds pattern-matching-related methods to [MonolithLocalizationPackageDto].
extension MonolithLocalizationPackageDtoPatterns on MonolithLocalizationPackageDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MonolithLocalizationPackageDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MonolithLocalizationPackageDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MonolithLocalizationPackageDto value)  $default,){
final _that = this;
switch (_that) {
case _MonolithLocalizationPackageDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MonolithLocalizationPackageDto value)?  $default,){
final _that = this;
switch (_that) {
case _MonolithLocalizationPackageDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'path_prefixes')  List<String> pathPrefixes, @JsonKey(name: 'resources_path')  String resourcesPath, @JsonKey(name: 'module_helper_class_name')  String moduleHelperClassName, @JsonKey(name: 'module_helper_path')  String moduleHelperPath)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonolithLocalizationPackageDto() when $default != null:
return $default(_that.pathPrefixes,_that.resourcesPath,_that.moduleHelperClassName,_that.moduleHelperPath);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'path_prefixes')  List<String> pathPrefixes, @JsonKey(name: 'resources_path')  String resourcesPath, @JsonKey(name: 'module_helper_class_name')  String moduleHelperClassName, @JsonKey(name: 'module_helper_path')  String moduleHelperPath)  $default,) {final _that = this;
switch (_that) {
case _MonolithLocalizationPackageDto():
return $default(_that.pathPrefixes,_that.resourcesPath,_that.moduleHelperClassName,_that.moduleHelperPath);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'path_prefixes')  List<String> pathPrefixes, @JsonKey(name: 'resources_path')  String resourcesPath, @JsonKey(name: 'module_helper_class_name')  String moduleHelperClassName, @JsonKey(name: 'module_helper_path')  String moduleHelperPath)?  $default,) {final _that = this;
switch (_that) {
case _MonolithLocalizationPackageDto() when $default != null:
return $default(_that.pathPrefixes,_that.resourcesPath,_that.moduleHelperClassName,_that.moduleHelperPath);case _:
  return null;
