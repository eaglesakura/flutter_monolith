...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String packageName,  String id,  Map<String, String> text,  List<String> placeHolders,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocalizedText() when $default != null:
return $default(_that.packageName,_that.id,_that.text,_that.placeHolders,_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String packageName,  String id,  Map<String, String> text,  List<String> placeHolders,  String? description)  $default,) {final _that = this;
switch (_that) {
case _LocalizedText():
return $default(_that.packageName,_that.id,_that.text,_that.placeHolders,_that.description);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String packageName,  String id,  Map<String, String> text,  List<String> placeHolders,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _LocalizedText() when $default != null:
return $default(_that.packageName,_that.id,_that.text,_that.placeHolders,_that.description);case _:
  return null;
